...
export function middleware(request: NextRequest) {
  ...
  const contentSecurityPolicy = `
    ...
    connect-src 'self' api.contentful.com cdn.contentful.com preview.contentful.com graphql.contentful.com *.contentful.com *.ctfassets.net assets.ctfassets.net downloads.ctfassets.net o2239.ingest.sentry.io *.sentry.io *.loom.com evs.sgmt.loom.com unpkg.com *.unpkg.com *.google-analytics.com *.analytics.google.com *.lottie.host lottie.host *.execute-api.us-west-2.amazonaws.com;
