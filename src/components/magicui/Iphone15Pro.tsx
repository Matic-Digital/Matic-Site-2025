...
export default function Iphone15Pro({
  ...
  // Convert width and height to numbers for viewBox calculation
  const viewBoxWidth = typeof width === 'number' ? width : 433;
  const viewBoxHeight = typeof height === 'number' ? height : 882;
