  ...
  return (
    <div className="relative w-full overflow-hidden">
      {isTwoImages ? (
        <div>
          {/* Background colors */}
          <div className="absolute inset-0 left-1/2 flex w-screen -translate-x-1/2 flex-col">
          ...
          {/* Content container */}
          <div className="relative px-4 pb-24 md:px-12 md:pt-24">
            {isMobile ? (
              // Mobile view - horizontal layout with minimal gap and taller section
              <div className="mx-auto flex min-h-[1000px] max-w-[1400px] flex-row items-center justify-center gap-0 px-1">
                <div className="flex h-full w-[49%] items-center justify-center">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={firstImage?.url ?? ''}
                    alt={firstImage?.description ?? ''}
                    className="h-[800px] w-full rounded-none border-none object-contain"
                ...
                <div className="flex h-full w-[49%] items-center justify-center">
                  ...
                  <img
                    ...
                    className="h-[800px] w-[80%] rounded-none border-none object-contain"
                    style={{ objectPosition: 'center' }}
                  />
                </div>
              </div>
              ...
              // Desktop view
              <div className="mx-auto flex min-h-[2400px] max-w-[1400px] flex-row items-end justify-center gap-10">
          ...
          {(() => {
            ...
            return (
              <>
                ...
                <div
                  className="absolute inset-0 left-1/2 flex w-screen -translate-x-1/2 flex-col"
                ...
                <div className="relative px-4 pb-24 md:px-12 md:pt-24">
                  <div
                    className="mx-auto flex h-full flex-col justify-center md:flex-row"
                    style={{ gap: '2.5rem' }}
                  >
          ...
          <div className="relative px-4 pb-24 md:px-12 md:pt-24">
            <div className="mx-auto flex justify-center">
              ...
              {isMobile ? (
                ...
                <div className="grid min-h-[800px] max-w-[1400px] grid-cols-2 grid-rows-3 gap-2 md:min-h-[2400px] md:gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 md:gap-4">
                    <div className="flex -translate-y-4 items-end justify-center md:-translate-y-12">
                      <div
                        className="relative scale-75 overflow-hidden"
                        style={{
                          maxWidth: '100%',
