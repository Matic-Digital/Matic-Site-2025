      ...
      <Box className="h-full justify-center space-y-4" direction="col">
        ...
        <Box className="space-y-1" direction="col">
          <TextEffect
            per="char"
            as="h2"
            className="font-chalet-newyork text-[1.25rem] leading-[130%] tracking-[-0.4px] text-text dark:text-maticblack"
          >
            {heading}
          </TextEffect>
          <TextEffect
            ...
            speedReveal={3}
            as="p"
            className="max-w-xl text-[0.875rem] leading-[160%] tracking-[-0.14px] text-text/80 dark:text-maticblack"
          >
            {copy}
          </TextEffect>
        </Box>
