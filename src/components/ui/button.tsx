...
const buttonVariants = cva('inline-flex items-center justify-center gap-2 whitespace-nowrap', {
  variants: {
    variant: {
      ...
      darkblue:
        'transition-all bg-darkblue hover:bg-darkblue/90 text-background rounded-[6px] text-background dark:text-text',
      ...
      ghost:
        'transition-all bg-transparent hover:bg-transparent text-text rounded-[6px] border border-text/80'
    },
    size: {
